...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../constants", "../git/blameFormat", "../utils/getFileName", "./complexRule", "./filterByBlame", "./getLevel"], factory);
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                needReports.forEach(function (_a) {
                    ...
                    var blames = (0, blameFormat_1.default)(filePath);
                    for (var j = 0; j < messages.length; j++) {
                        var _b = messages[j], message = _b.message, ruleId = _b.ruleId, line = _b.line, column = _b.column, severity = _b.severity;
                        // 过滤掉该行，不属于在指定时间内的修改
                        var filterBlame = (0, filterByBlame_1.default)({ line: line, blames: blames, since: since });
                        ...
                        if (msgLevle && (msgLevle === null || msgLevle === void 0 ? void 0 : msgLevle.level) !== filterLv) {
                            result.push(__assign({ position: "".concat(line, ",").concat(column), fileName: (0, getFileName_1.default)(filePath), author: filterBlame.author, rule: ruleId }, msgLevle));
                        }
                    }
                });
