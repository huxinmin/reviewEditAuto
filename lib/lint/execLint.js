...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "eslint", "../utils/getFileName", "./complexRule", "./filterByBlame", "./getLevel"], factory);
    }
    ...
    var lint = new eslint_1.ESLint({
        useEslintrc: true,
    });
    function execLint(paths, min, since, filterLv) {
        return __awaiter(this, void 0, void 0, function () {
            var reports, needReports, result, fileCount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, lint.lintFiles(paths)];
                    case 1:
                        reports = _a.sent();
                        ...
                        needReports.forEach(function (_a) {
                            ...
                            for (var j = 0; j < messages.length; j++) {
                                ...
                                if (msgLevle && (msgLevle === null || msgLevle === void 0 ? void 0 : msgLevle.level) !== filterLv) {
                                    result.push(__assign({ position: "".concat(line, ",").concat(column), fileName: (0, getFileName_1.default)(filePath), author: blames.author }, msgLevle));
                                }
                            }
                        });
