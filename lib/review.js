...
(function (factory) {
    ...
    function review(param) {
        return __awaiter(this, void 0, void 0, function () {
            var start, _a, min, _b, rootPath, _c, ignoreFileName, _d, ignoreRules, _e, since, _f, filterLv, lintResult, fileCount, result;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        logger_1.default.loading('excuting code review...');
                        start = Date.now();
                        _a = param.min, min = _a === void 0 ? 10 : _a, _b = param.rootPath, rootPath = _b === void 0 ? '' : _b, _c = param.ignoreFileName, ignoreFileName = _c === void 0 ? '.gitignore' : _c, _d = param.ignoreRules, ignoreRules = _d === void 0 ? ['node_modules'] : _d, _e = param.since, since = _e === void 0 ? '1.week' : _e, _f = param.filterLv, filterLv = _f === void 0 ? '' : _f;
